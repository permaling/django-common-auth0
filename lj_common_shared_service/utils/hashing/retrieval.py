...
from .search.bktree import BKTree
from .search.brute_force import BruteForce
from .threading import run_processes_pool

logger = logging.getLogger(__name__)


class LJHashEvaluator:
    def __init__(
            self,
            test: Dict,
            queries: Dict,
    ...
    def _searcher(self, data_tuple: Tuple) -> None:
        """
    ...
    def _get_query_results(
        ...
        result_map_list = run_processes_pool(
